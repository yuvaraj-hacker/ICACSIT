                ...
                <div className='max-w-[90rem] mx-auto  md:px-5  px-3'>
                    <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1   gap-5 mb-10'>
                        <div className=" mx-auto text-left py-6 px-4 flex flex-col gap-4 shadow-lg rounded-lg w-full h-full">
                            <h1 className='md:text-2xl text-xl font-semibold text-[#155DFC]'>Artificial Intelligence & Machine Learning</h1>
                        ...
                        <div className=" mx-auto text-left py-6 px-4 flex flex-col gap-4 shadow-lg rounded-lg w-full h-full">
                            <h1 className='md:text-2xl text-xl  font-semibold text-[#155DFC]'>Quantum Computing & Future Computing</h1>
                            <ul className="list-disc pl-5 space-y-2 md:text-lg">
                        ...
                        <div className=" mx-auto text-left py-6 px-4 flex flex-col gap-4 shadow-lg rounded-lg w-full h-full">
                            <h1 className='md:text-2xl text-xl  font-semibold text-[#155DFC]'>Intelligent Systems & Automation</h1>
                            <ul className="list-disc pl-5 space-y-2 md:text-lg">
                        ...
                        <div className=" mx-auto text-left py-6 px-4 flex flex-col gap-4 shadow-lg rounded-lg w-full h-full" >
                            <h1 className='md:text-2xl text-xl  font-semibold text-[#155DFC]'>Data Science & Big Data Technologies</h1>
                            <ul className="list-disc pl-5 space-y-2 md:text-lg">
                        ...
                        <div className=" mx-auto text-left py-6 px-4 flex flex-col gap-4 shadow-lg rounded-lg w-full h-full">
                            <h1 className='md:text-2xl text-xl  font-semibold text-[#155DFC]'>Internet of Things (IoT) & Smart Technologies</h1>
                            <ul className="list-disc pl-5 space-y-2 md:text-lg">
                        ...
                        <div className=" mx-auto text-left py-6 px-4 flex flex-col gap-4 shadow-lg rounded-lg w-full h-full">
                            <h1 className='md:text-2xl text-xl  font-semibold text-[#155DFC]'>NLP & Computer Vision</h1>
                            <ul className="list-disc pl-5 space-y-2 md:text-lg">
                        ...
                        <div className=" mx-auto text-left py-6 px-4 flex flex-col gap-4 shadow-lg rounded-lg w-full h-full">
                            <h1 className='md:text-2xl text-xl  font-semibold text-[#155DFC]'>Cyber-Physical Systems & Embedded AI</h1>
                            <ul className="list-disc pl-5 space-y-2 md:text-lg">
                        ...
                        <div className=" mx-auto text-left py-6 px-4 flex flex-col gap-4 shadow-lg rounded-lg w-full h-full">
                            <h1 className='md:text-2xl text-xl  font-semibold text-[#155DFC]'>Ethics, Governance & Social AI</h1>
                            <ul className="list-disc pl-5 space-y-2 md:text-lg">
