                ...
                <section>
                    <div className="py-10 pt-16  md:pt-10">
                        <div className="text-center">
                            <h1 className="text-3xl md:text-4xl font-bold pb-6  relative inline-block after:content-[''] after:block after:w-40 after:h-1.5 after:bg-[#FFD700] after:mx-auto after:mt-2">
