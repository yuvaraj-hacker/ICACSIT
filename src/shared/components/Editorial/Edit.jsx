...
function Edit({ position, name, location }) {
    return (
        <>
            <div className=" relative  bg-white border-2 border-b-2   rounded-lg  hover:shadow-2xl shadow-xl transition-all duration-500 p-6 transform hover:-translate-y-2">
