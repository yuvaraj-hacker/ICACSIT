    ...
    return (
        <>
            <section className='min-h-[65vh]'>
                ...
                <div className='  bg-gray-100 md:p-6 p-3 rounded-lg font-sans  mt-10 mx-auto flex flex-col md:flex-col 2xl:items-start gap-5 lg:gap-5'>

                    <div className="grid  grid-cols-1 lg:grid-cols-3 md:gap-10 gap-5 mx-auto">
