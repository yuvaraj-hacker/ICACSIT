        ...
        <>
            <section className='min-h-[65vh]'>
                <div className="text-center mt-28">
                    <h1 className="text-3xl md:text-4xl font-bold md:pb-5 pb-5  relative inline-block after:content-[''] after:block after:w-40 after:h-1.5 after:bg-[#FFD700] after:mx-auto after:mt-2">
                        Editorial Board
                    </h1>
                </div>
                ...
                <div className="max-w-[90%]   lg:max-w-[80%] 2xl:max-w-[70%] mt-10 mx-auto flex flex-col md:flex-col 2xl:items-start gap-5 lg:gap-5">
